...
<Columns cols="3">
  ...
  <Card title="Reputação Online" href="/reputao-online" icon="star" cta="Explorar" horizontal="false" target="_self">
    Peça avaliações no Google e outros canais a partir das respostas de promotores.
  </Card>

  <Card title="Integrações e API" href="/como-funcionam-as-integraes" icon="plug" cta="Explorar" horizontal="false" target="_self">
