...
description: >-
  ...
  avançados por campo customizado, acompanhe convites e entenda as taxas de
  envio e erro na aba Convites.
---
## Visão geral
...
- **Convites** — onde ficam os registros dos convites e dos envios (manuais e automáticos)
...
A aba Convites exibe todos os convites e os envios que saíram — manuais, automáticos e por lembrete automático — com o status de cada envio.

<Image src="https://cdn.amplifique.me/central-de-ajuda/618eb26fb64d9ca570ab3e3335aa71c8.png" width="1920" height="869" />

<Callout kind="tip" collapsed="false">
  Um convite pode ter vários envios: o inicial e cada lembrete automático. Veja a diferença em [Envio ou Convite?](/envio-ou-convite) e como escolher o que a lista mostra em [Como filtrar envios e lembretes na aba Convites?](/como-filtrar-envios-e-lembretes-na-aba-convites).
</Callout>
...
Acesse `Pesquisas e Respostas → Convites` e verifique o status de cada disparo.
...
<Card title="Como exportar respostas de pesquisas?" href="/como-exportar-respostas-de-pesquisas" icon="download" cta="Ver artigo" horizontal="false">
  Exporte todas as respostas em planilha Excel para análise externa, com filtros por tipo (finalizadas, não finalizadas, convites).
</Card>
