...
<Card title="Payload do evento cf_response" icon="code" href="/webhook-cf-response" cta="Ver estrutura completa" horizontal="true" target="_self">
  Todos os campos do JSON, tipos de pergunta e formatos de data.
</Card>
...
<Expandable title="Não dependa da ordem de chegada">
  Com retentativas em paralelo, um evento que falhou pode chegar depois de um evento mais recente que teve sucesso na primeira tentativa. Use os campos de data do payload (`finalized_at`, `created_at`) para ordenar, nunca a ordem de recebimento.
</Expandable>
...
<Card title="Payload do cf_response" icon="code" href="/webhook-cf-response" cta="Ver estrutura" horizontal="true" target="_self">
  Referência completa dos campos do evento de nova resposta.
</Card>
