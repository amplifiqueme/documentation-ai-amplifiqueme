...
O card de Métricas de Pesquisas mostra **Convites Respondidos** e o card de Métricas de Perguntas mostra **Respostas Recebidas**. Parecem a mesma coisa, mas cada um responde uma pergunta diferente:
