...
Os dois cards mostram o campo **Respostas Recebidas**, mas cada um responde uma pergunta diferente:
...
| ------------------------- | -------------------------------------------------------------------------- | ----------------------------------------------------------- |
| **Métricas de Pesquisas** | Convites: 2 · Respostas Recebidas: 2 · Taxa de Resposta por Convite: 100%  | Respostas 1 e 2 — os dois convites saíram em agosto         |
| **Métricas de Perguntas** | Respostas Recebidas: 1                                                     | Resposta 2 — a única que chegou em agosto                   |

### Painel filtrado em setembro

| Card                      | O que aparece                                                              | Quais respostas entram                                  |
| ------------------------- | -------------------------------------------------------------------------- | ------------------------------------------------------- |
| **Métricas de Pesquisas** | Convites: 1 · Respostas Recebidas: 1 · Taxa de Resposta por Convite: 100%  | Resposta 3 — o único convite que saiu em setembro       |
| **Métricas de Perguntas** | Respostas Recebidas: 2                                                     | Respostas 1 e 3 — as duas chegaram em setembro          |
...
| ----------------------------- | ------------------------------------- | ------------------------------ |
| 01/09                         | 100 convites · 40 respostas · 40%     | 45 respostas                   |
| 15/09                         | 100 convites · 55 respostas · 55%     | 45 respostas                   |
