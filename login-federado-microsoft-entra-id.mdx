...
- Que o e-mail cadastrado de cada usuário na Amplifique.me seja **exatamente igual** ao nome principal de usuário (UPN) dele no Entra ID
...
| *"Erro de autenticação com Login Federado Microsoft Entra ID"*     | O e-mail na plataforma é diferente do UPN no Entra ID                           | Ajustar o cadastro para o mesmo endereço usado no Entra ID                    |
